...
- STROBE - fast on/off for critical or fault.
- CODE - blink count for error codes.
...
- IDLE / READY - `#3CC83C`
  <img alt="#3CC83C" src="https://placehold.co/16x16/3CC83C/3CC83C.png" /> - Soft green heartbeat when the system is in prep (relay on, outputs off).
- RUN - `#00FF78`
  <img alt="#00FF78" src="https://placehold.co/16x16/00FF78/00FF78.png" /> - Bright green double heartbeat while actively delivering power (boost and equilibrium).
...
- MAINT - `#008CFF`
  <img alt="#008CFF" src="https://placehold.co/16x16/008CFF/008CFF.png" /> - Blue breathe in maintenance or service mode.
- OFF / SLEEP - `#000000`
  <img alt="#000000" src="https://placehold.co/16x16/000000/000000.png" /> - LED off (relay off).
- FAULT - `#FF0000`
  <img alt="#FF0000" src="https://placehold.co/16x16/FF0000/FF0000.png" /> - Red strobe for latched critical fault.

## Latched alerts (warning/error reminders)
Latched alerts sit above the background and persist until cleared. Short overlays can still flash, then the alert resumes.
- `setAlert(WARN)` - yellow blink (warning level).
- `setAlert(CRITICAL)` - red strobe (error level).
- `clearAlert()` - return to normal background.

## Overlays (short cues that preempt backgrounds)

### WiFi and Web
- WiFi STA joined - `#00FF00`
  <img alt="#00FF00" src="https://placehold.co/16x16/00FF00/00FF00.png" /> - Short green flash when joining the router.
- WiFi AP active - `#FFE628`
  <img alt="#FFE628" src="https://placehold.co/16x16/FFE628/FFE628.png" /> - Short yellow flash when AP is active.
- WiFi link lost - `#FFAA00`
  <img alt="#FFAA00" src="https://placehold.co/16x16/FFAA00/FFAA00.png" /> - Amber flash when WiFi link drops.
...
- Sensor missing - `#50A0FF`
  <img alt="#50A0FF" src="https://placehold.co/16x16/50A0FF/50A0FF.png" /> - Blue blink when a sensor is missing or invalid.
- Config error - `#FF3CB4`
  <img alt="#FF3CB4" src="https://placehold.co/16x16/FF3CB4/FF3CB4.png" /> - Magenta strobe on configuration or NVS error.
...
### General
- Wake flash - `#DCDCDC`
  <img alt="#DCDCDC" src="https://placehold.co/16x16/DCDCDC/DCDCDC.png" /> - Soft white flash once on wake or tap.
...
Color semantics: green/teal = good or active, yellow/amber = pending or caution, red = fault or critical, blue/magenta = sensor or configuration issues, white = neutral system cue.
